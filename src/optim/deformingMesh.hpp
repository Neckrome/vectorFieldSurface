...
class DeformingMesh
{
    ...
    static std::unique_ptr<VertexPositionGeometry> analyticSolve(ManifoldSurfaceMesh& mesh, VertexPositionGeometry& geometry, VertexData<Vector3>& bondaryFixedValues, FaceData<Vector3>& normals);
