...
class DeformingMesh
{
    ...
    DeformingMesh();
    static std::unique_ptr<VertexPositionGeometry> iterativeSolve(ManifoldSurfaceMesh& mesh, VertexPositionGeometry& geometry, VertexPositionGeometry& origGeom, FaceData<Vector3>& normals);
